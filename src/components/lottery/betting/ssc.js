...
export default {
    ...
    first_three: {
        ...
        group_first_three_three_duplex(data) {
            var rst = { count: 0, numbers: '' }
            var group_three = data['group_three']
    ...
    not_location: {
    	not_location_last_three_one_code(data){
    		var rst = { count: 0, numbers: '' }
            var not_location_title = data['not_location_title']
    ...
    interesting: {
    	interesting_one(data){
    		var rst = { count: 0, numbers: '' }
            var interesting_title = data['interesting_title']
