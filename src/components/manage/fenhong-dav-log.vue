    	            ...
    	            <table id="thetable" border="0" width="100%" cellspacing="0" cellpadding="0">
    	                ...
    	                <tbody>
    	                    ...
    	                    <tr v-for="item in data"> 
    	                        ...
    	                        <td>
                                    <span v-if="item.cpyk+item.qpyk+item.zryk ==0" class="numRed">0</span>
                	...
                	<table border="0" width="100%" cellpadding="0" cellspacing="0" style="padding-top: 10px">
                		<tbody>
                			...
                			<tr>
                				...
                				<td>团队综合盈亏：<span v-text="zh" :title="zh" class="numRed"></span></td>
                			</tr>
                		</tbody>
                	</table>
                </dd>
    ...
    export default {
        ...
        methods :{
            search(){
                ...
                api.ajax('team/dividend/listDailyReport',this.form).then(data => {
                    if(data && data.code == '0'){
                        this.show = false;
                        this.data = data.data;
                    } else {
