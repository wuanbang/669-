		...
		<div class="grey_box_top">
			<div class="grey_box_bottom">
				<div class="searchBar">
                    ...
                    玩家帐号:<input type="text" v-model="value5" name="username" class="inputWid"><input type="checkbox" name="checkbox">包含下级
	...
	export default {
		...
		methods : {
			search () {
                ...
                this.form.operaType = this.value4;
                this.form.username = this.value5;
                this.form.pageNumber = 1; 
                api.ajax('team/pageTeamCoinChange',this.form).then(data => {
                    if(data && data.code == '0'){
                        this.show = false;
